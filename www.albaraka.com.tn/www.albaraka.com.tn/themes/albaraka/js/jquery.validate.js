...
(function (factory) {
    ...
    validate: function (options) {
      ...
      if (!this.length) {
        if (options && options.debug && window.console) {
          console.warn(
            Drupal.t("Nothing selected, cant validate, returning nothing.")
          );
        }
        return;
      }
  ...
  $.extend($.validator, {
    ...
    messages: {
      ...
      email: Drupal.t("Veuillez fournir une adresse électronique valide."),
      url: Drupal.t("Veuillez fournir une adresse URL valide."),
      date: Drupal.t("Veuillez fournir une date valide."),
      dateISO: Drupal.t("Please enter a valid date (ISO)."),
      number: Drupal.t("Veuillez fournir un numéro valide."),
      digits: Drupal.t("Veuillez fournir seulement des chiffres."),
      equalTo: Drupal.t("Please enter the same value again."),
      maxlength: $.validator.format(
        Drupal.t("Veuillez fournir au plus {0} caractères.")
      ),
      minlength: $.validator.format(
        Drupal.t("Veuillez fournir au moins {0} caractères.")
      ),
      ...
      range: $.validator.format(
        Drupal.t("Please enter a value between {0} and {1}.")
      ),
      max: $.validator.format(
        Drupal.t("Please enter a value less than or equal to {0}.")
      ),
      min: $.validator.format(
        Drupal.t("Please enter a value greater than or equal to {0}.")
      ),
      step: $.validator.format(Drupal.t("Please enter a multiple of {0}.")),
    },
