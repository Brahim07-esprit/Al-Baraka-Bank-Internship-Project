...
(function ($, Drupal) {
  ...
  $.fn.isWebform = function () {
    return $(this).closest('form[id^="webform"], form[data-is-webform]').length
      ? true
      : false;
  };
  ...
  $document.on("state:required", function (e) {
    if (e.trigger && $(e.target).isWebformElement()) {
      ...
      if (
        $target.is(
          ".js-form-type-radios, .js-form-type-webform-radios-other, .js-webform-type-radios, .js-webform-type-webform-radios-other"
        )
      ) {
