/*1691769316,,JIT Construction: v1008018202,fr_FR*/
            ...
            function (a, b, c, d, e, f, g) {
              ...
              a = (function (a) {
                ...
                e.$ChatDOMFacade18 = function (a) {
                  switch (a) {
                    case "chat":
                      return c("sdk.fbt")._("Discussion");
                    case "help":
                      return c("sdk.fbt")._("Aide");
                    case "ask_us":
                      return c("sdk.fbt")._("Demandez-nous");
                    case "none":
                      return "";
                  }
                };
          ...
          __d(
            ...
            function (a, b, c, d, e, f, g) {
              ...
              a = {
                ...
                logout: c("sdk.fbt")._("D\u00e9connexion"),
                logoutButtonAriaLabel: c("sdk.fbt")._(
                  "Se d\u00e9connecter du site web actuel"
                ),
                titleText: c("sdk.fbt")._("Choisir un compte"),
                promptText: c("sdk.fbt")._(
                  "Quel compte voulez-vous utiliser pour vous connecter\u00a0?"
                ),
                facebookText: c("sdk.fbt")._("Se connecter avec Facebook"),
                facebookTextShort: c("sdk.fbt")._("Se connecter"),
                instagramText: c("sdk.fbt")._("Se connecter avec Instagram"),
                disambiguationDialogAriaLabelText: c("sdk.fbt")._(
                  "Log in with Facebook or Instagram"
                ),
                fbButtonText: c("sdk.fbt")._("Continuer avec Facebook"),
                igButtonText: c("sdk.fbt")._("Continuer avec Instagram"),
              };
            ...
            function (a, b, c, d, e, f, g) {
              ...
              var h = (function (b) {
                ...
                d.process = function () {
                  ...
                  this.$MessengerCheckboxWrapper1 = new (c(
                    "sdk.XFBML.MessengerCheckbox"
                  ))(
                    this.$MessengerCheckboxWrapper2,
                    this.$MessengerCheckboxWrapper3,
                    this.$MessengerCheckboxWrapper4,
                    this.$MessengerCheckboxWrapper5
                  );
                  this.$MessengerCheckboxWrapper1.subscribe(
                    "render",
                    function () {
                      a.inform("render");
                    }
            ...
            function (a, b, c, d, e, f, g) {
              ...
              var h = (function (b) {
                ...
                d.process = function () {
                  ...
                  this.$MessengerMessageUsWrapper1 = new (c(
                    "sdk.XFBML.MessengerMessageUs"
                  ))(
                    this.$MessengerMessageUsWrapper2,
                    this.$MessengerMessageUsWrapper3,
                    this.$MessengerMessageUsWrapper4,
                    this.$MessengerMessageUsWrapper5
                  );
                  this.$MessengerMessageUsWrapper1.subscribe(
                    "render",
                    function () {
                      a.inform("render");
                    }
            ...
            function (a, b, c, d, e, f, g) {
              ...
              var h = (function (b) {
                ...
                d.process = function () {
                  ...
                  this.$SendToMessengerWrapper1 = new (c(
                    "sdk.XFBML.SendToMessenger"
                  ))(
                    this.$SendToMessengerWrapper2,
                    this.$SendToMessengerWrapper3,
                    this.$SendToMessengerWrapper4,
                    this.$SendToMessengerWrapper5
                  );
                  this.$SendToMessengerWrapper1.subscribe(
                    "render",
                    function () {
                      a.inform("render");
                    }
            ...
            function (a, b, c, d, e, f, g) {
              var h = function () {
                function a(a) {
                  ...
                  e.textContent = c("sdk.fbt")._("Partager sur Facebook");
  ...
  i.src =
    ...
    encodeURIComponent(
      '{"error":"LOAD", "extra": {"name":"' +
        ...
        '","revision":"1008018202","namespace":"FB","message":"' +
        e.message +
        '"}}'
    );
