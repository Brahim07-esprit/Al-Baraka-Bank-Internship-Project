  ...
  function (a, b, c, d, e, f, g) {
    var h = "/ajax/chat/privacy/settings.php",
      ...
      n = babelHelpers["extends"](
        {},
        d("PresencePrivacyInitialData").privacyData
      ),
  ...
  function (a, b, c, d, e, f, g, h) {
    ...
    function j(a) {
      ...
      if (a <= 1)
        ...
        return h._({ "*": "{count} j" }, [h._param("count", c, [0])]);
      else return null;
    }
    function k(a, b) {
      (!(a in i) || i[a] < b) && (i[a] = b);
...
__d(
  ...
  function (a, b, c, d, e, f, g) {
    ...
    function n(a) {
      ...
      l.checkPresence(e);
      l.get(e) === c("AvailableListConstants").ACTIVE &&
        (window.clearTimeout(k[e].timeout),
        (k[e].timeout = window.setTimeout(function () {
          l.checkPresence(e);
        }, f)));
    }
    function o(a) {
    ...
    Object.assign(l, {
      ...
      get: function (a) {
        ...
        o(a) &&
          ...
          !k[a] &&
          (d("ODS").bumpEntityKey(3303, "presence", "page_subscribe"),
          (k[a] = {}),
      ...
      getGroup: function (a) {
        return a.some(function (a) {
          return a == c("CurrentUser").getID()
            ? !1
            : l.get(a) === c("AvailableListConstants").ACTIVE;
        })
          ? c("AvailableListConstants").ACTIVE
          : c("AvailableListConstants").OFFLINE;
      },
      ...
      getOnlineIDs: function () {
        var a,
          b = [];
        for (a in h)
          l.get(a) === c("AvailableListConstants").ACTIVE && b.push(a);
        return b;
      },
      getAllIDs: function () {
      ...
      getAllDebugInfo: function () {
        var a = {};
        for (var b in h) a[b] = { p: h[b], vc: i[b] };
        return a;
      },
      ...
      setMultiActive: function (a, b) {
        var d = !1;
        a.forEach(function (a) {
          l.set(a, c("AvailableListConstants").ACTIVE, !1, b, null, !0) &&
            (d = !0);
        });
        d && m();
      },
    ...
    c("AvailableListInitialData").playingNow &&
      ...
      l.setPlayingCanvasGameFriends(c("AvailableListInitialData").playingNow);
