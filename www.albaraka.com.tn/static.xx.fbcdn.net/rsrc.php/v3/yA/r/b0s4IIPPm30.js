...
__d(
  ...
  function (a, b, c, d, e, f, g) {
    ...
    function b(a, b) {
      ...
      return d == null
        ? h(a, b)
        : j(c("getViewportDimensions")(), a, b, d.clientHeight);
    }
    var i = function (a, b) {
...
__d(
  "VideoFeedFastPreloadController",
  ["DOMQuery", "Run"],
  function (a, b, c, d, e, f, g) {
    var h = 0;
    function b(b) {
      h < 2 &&
        ((b = d("DOMQuery").scry(b, "video")[0]),
        b instanceof a.HTMLVideoElement &&
          (h ||
    ...
    a = (function () {
      ...
      c.$3 = function () {
        ...
        if (this.$1.isState("playing")) {
          ...
          b("logVideosClickTracking")(this.$2), this.$1.play("user_initiated");
      };
      c.$4 = function () {
        var a = this.$1.getOption(
          "CommercialBreakVideoAdOverlay",
      ...
      e.$15 = function (e) {
        ...
        h.setErrorHandler(function (a) {
          ...
          for (var b = 0; b < j.length; b++)
            j[b].reject(
              d("VideoPlayerShakaError").translateError(a, g, "preload")
            );
        });
  ...
  function (a, b, c, d, e, f, g) {
    ...
    function b(a, b) {
      ...
      h[e] = c("Event").listen(a, "click", function () {
        b && (d("CSS").hide(a), d("CSS").show(b)),
          d("DataStore").set(a, "clicked", !0);
      });
      b &&
        (h[e + i] = c("Event").listen(b, "click", function () {
          b && d("CSS").hide(b),
            d("CSS").show(a),
            d("DataStore").set(a, "clicked", !1);
        }));
    }
    function e(a) {
      a = a.id;
...
__d(
  ...
  function (a, b, c, d, e, f, g) {
    function h(a) {
      var b = c("VideoPlayerHTML5Experiments").useMonotonicallyIncreasingTimers
    ...
    a = (function () {
      ...
      b.subscribe = function (a, b, e, f) {
        ...
        a = d("RelayRTIGraphQLSubscriber")
          .subscribe(h, g, j, e == null ? void 0 : e.viewerID, f)
          ["do"]({
            start: function () {
...
__d(
  "ReStoreLocalStorageQuotaExceed",
  ["FBLogger", "recoverableViolation"],
  function (a, b, c, d, e, f, g) {
    "use strict";
    var h = "Failed to execute 'setItem' on 'Storage'",
      i = "ReStoreLocalStorageQuotaExceed";
    function j() {
      try {
        ...
        if (a != null && a.length !== 0)
          for (var e in a) {
            ...
            var f = ((a[e] || "").length + e.length) * 2;
            f / 1024 > 2e3 && b.push(e);
          }
        c("FBLogger")("messenger_web_product").mustfix(
          h + ": QuotaExceeded - trying to clean up %s or %s",
          b.join(","),
          d.join(",")
        );
        ...
        c("FBLogger")("messenger_web_product").mustfix(
          "Error getting local storage big values for cleanup."
        );
        return [];
      }
    }
    function a() {
      try {
        ...
        c("recoverableViolation")(
          "Couldn't remove vals from localStorage",
    ...
    g.ERROR_NAME = i;
    g.getLocalStorageValuesToRemoveOnExceed = j;
    g.clearLocalStorageBigValues = a;
    g.ReStoreLocalStorageQuotaExceed = b;
  },
  98
);
