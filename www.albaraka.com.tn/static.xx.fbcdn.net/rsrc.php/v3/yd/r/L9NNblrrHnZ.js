...
__d(
  ...
  function (a, b, c, d, e, f, g) {
    ...
    function i(a) {
      ...
      if (
        c("gkx")("3752") &&
        typeof h.__sapienzMetadataCallback__ === "function"
      ) {
    ...
    function k(a, d) {
      return new (b("Promise"))(function () {
        var b = d || a;
        typeof h.__je2e_recordQPLMarker === "function" &&
          h.__je2e_recordQPLMarker(b);
        c("Env").enable_qplinspector === !0 && c("QPLInspector").appendLog(b);
    ...
    typeof h.__je2e_felabsTracePlugin_setQplInit === "function" &&
      h.__je2e_felabsTracePlugin_setQplInit(c("performanceNow")());
    var p = {
