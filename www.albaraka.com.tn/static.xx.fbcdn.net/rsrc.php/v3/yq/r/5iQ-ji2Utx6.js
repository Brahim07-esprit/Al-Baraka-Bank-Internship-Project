...
__d(
  "LiveVideoWorkplaceP2PPlaybackTypedLogger",
    ...
    a = (function () {
      ...
      c.log = function (a) {
        b("GeneratedLoggerUtils").log(
          "logger:LiveVideoWorkplaceP2PPlaybackLoggerConfig",
          this.$1,
          b("Banzai").BASIC,
          a
        );
...
__d(
  ...
  function (a, b, c, d, e, f) {
    a = {
      ...
      filter_out_source_representation: !1,
      ...
      function a(a, b, e) {
        ...
        this.$21 = function (a) {
          ...
          a = f.$5.setMediaKeys(e).then(function () {
            if (f.$4)
              return c("oz-player/shims/OzMaybeNativePromise").reject(
                new Error("OzDrmManager destroyed after setMediaKeys() called.")
              );
        ...
        this.$22 = function (a) {
          ...
          a = a.map(function (a) {
            return f.$24(b, e, { initData: a.data, initDataType: a.type });
          });
          ...
          e != null &&
            e.forEach(function (a) {
              ...
              e ||
                ...
                b.set(d, e));
              c === "audio" &&
                !e.audioCapabilities.has(f) &&
                e.audioCapabilities.set(f, {
                  contentType: f,
                  robustness: a.getAudioRobustness(),
                });
              c === "video" &&
                !e.videoCapabilities.has(f) &&
                e.videoCapabilities.set(f, {
                  contentType: f,
      ...
      b.$11 = function (a) {
        this.getType() && a.setType(this.getType()),
          ...
          typeof this.getIsP2pPlayback() === "boolean" &&
            a.setIsP2pPlayback(this.getIsP2pPlayback()),
          typeof this.getIsRingBufferSample() === "boolean" &&
            a.setIsRingBufferSample(this.getIsRingBufferSample());
      };
      return a;
    })();
    f["default"] = a;
  ...
  function (a, b, c, d, e, f, g) {
    ...
    a = {
      ...
      getBandwidthMeanEstimate: function (a) {
        var b = c("VideoPlayerOzWWWGlobalConfig").getString(
            "bandwidth_estimate_header_key",
            ""
          ),
          d = c("VideoPlayerOzWWWGlobalConfig").getString(
            "bandwidth_estimate_key",
            ""
          );
        return i(a, b, d);
    ...
    a = (function () {
      ...
      b.updateWith = function (b) {
        b instanceof a || c("oz-player/shims/ozvariant")(0, 229),
          this.$7.updateWith(b.$7);
      };
      b.getSegmentByTime = function (a) {
        return this.$7.getSegmentByTime(a);
      };
      b.getSegment = function (a) {
        return this.$7.getSegment(a);
      };
      b.getPredictedSegmentAfter = function (a) {
        return this.$7.getPredictedSegmentAfter(a);
      };
      b.canPredict = function () {
        return this.$7.canPredict();
      };
      b.canApproximateId = function () {
        return this.$7.canApproximateId();
      };
      b.getSegmentAfter = function (a) {
        return this.$7.getSegmentAfter(a);
      };
      b.isEndingSegment = function (a) {
        return this.$7.isEndingSegment(a);
      };
      b.addUpdateListener = function (a) {
        return this.$7.addUpdateListener(a);
      };
      b.getTimeRanges = function () {
        return this.$7.getTimeRanges();
      };
      b.blockTimeRange = function (a) {
        this.$7.blockTimeRange(a);
      };
      b.getEndingSegment = function () {
        return this.$7.getEndingSegment();
      };
      b.getMaxGopSec = function () {
        return this.$7.getMaxGopSec();
      };
      return a;
    })();
    g["default"] = a;
  ...
  function (a, b, c, d, e, f, g) {
    ...
    a = (function (a) {
      ...
      function b(b, c, d, e, f, g, h, i, j, k, l, m, n) {
        c = a.call(this, b, c, d, e, f, g, h, i, j, k, l) || this;
        c.$OzVideoRepresentation5 = null;
        c.$OzVideoRepresentation1 = m;
        c.$OzVideoRepresentation2 = n;
        c.$OzVideoRepresentation4 = l;
    ...
    a = (function () {
          ...
          c("oz-player/shims/OzDOMEventListener").listenDOMEvent(
            ...
            function () {
              ...
              b.$5
                ...
                .setResult("failed")
                .setUserInfo({ av1HardwareSupport: b.$22 })
                .log();
              b.$8 = [];
              b.$6 = [];
              b.$4.release();
              ...
              var d = (a == null ? void 0 : a.code) || 0,
                e = new (c("oz-player/utils/OzError"))({
                  type: c("oz-player/utils/ozGetErrorNameFromMediaErrorCode")(
                    d
                  ),
                  description:
              ...
              b.$18 == null &&
                (b.$18 = c("oz-player/shims/ozSetTimeoutAcrossTransitions")(
                  function () {
                    (b.$18 = null),
                      b.$11.getBool("retry_video_element_error") &&
                        (b.$17 != null && b.$17(e), b.$23());
                  },
                  0
                ));
            }
      ...
      b.$24 = function (a) {
        ...
        a
          ...
          : (b.removeAttribute("src"), b.removeAttribute("srcObject"));
      };
      b.$23 = function () {
        var a = this;
      ...
      b.$29 = function (a) {
        ...
        return c("oz-player/shims/getOzVTTSourceBufferImpl")().then(function (
          ...
          if (b.$21 != null) {
            var e = new d({ onCaptionsChanged: b.$21 }),
      ...
      b.detach = function () {
        this.$18 &&
          (c("oz-player/shims/ozClearTimeout")(this.$18), (this.$18 = null));
        this.$5
      ...
      b.$31 = function () {
        return (
          !this.$30() && this.$2.readyState === "open" && !this.$10 && !this.$12
        );
      };
      b.$30 = function () {
    ...
    function a(a, b, d, e, f, g, h, i) {
      ...
      return g.then(function (a) {
        var b = a.ok,
          d = a.status,
          f = a.headers;
        return e != null && !b && typeof a.text === "function"
          ? a.text().then(function (c) {
              return {
                ok: b,
                status: d,
                headers: f,
  ...
  function (a, b, c, d, e, f, g) {
    ...
    function a(a) {
      ...
      if (h)
        ...
        var n;
        n =
          (n = g == null ? void 0 : g.retryAttempts_SIDX_USE_ONLY) != null
            ? n
            : 0;
        if (n > 0) {
          var o;
          o =
            (o = g == null ? void 0 : g.retryTimeoutMs_SIDX_USE_ONLY) != null
              ? o
              : 100;
  ...
  function (a, b, c, d, e, f, g) {
    ...
    a = (function () {
      ...
      b.$18 = function (a) {
        ...
        this.$7 = a;
        return { requestPromise: e, requestUrl: d };
      };
  ...
  function (a, b, c, d, e, f, g) {
    ...
    var h = {
      ...
      systemic_risk_abr_prefetch_low_mos_resolution:
        (e = c("qex")._("2090")) != null ? e : 260,
      systemic_risk_abr_min_watchable_mos:
        (f = c("qex")._("2091")) != null ? f : 0,
      systemic_risk_abr_parse_prefetch_mos:
        (b = c("qex")._("2092")) != null ? b : !1,
    };
    function a() {
...
__d(
  "oz-player/shims/www/OzWindowEventsWWW",
  ["cr:925100"],
  function (a, b, c, d, e, f, g) {
    "use strict";
    a = {
  ...
  function (a, b, c, d, e, f, g) {
    ...
    a = (function () {
      ...
      b.hasRecentBandwidthEstimateFromHeader = function () {
        var a = c("oz-player/configs/OzGlobalConfig").getNumber(
            "bandwidth_header_expire_threshold",
            0
          ),
          b = this.$6;
  ...
  function (a, b, c, d, e, f, g) {
    ...
    b = (function () {
      ...
      e.$25 = function () {
        ...
        this.$20 = !0;
        a = c("oz-player/shims/OzNetworkDiagnostics").getBandwidthMeanEstimate(
          a
        );
        a != null && this.$14(a);
      };
      ...
      return {
        startStream: function (g) {
          ...
          i.onEstimateFromHeaders(function (a) {
            e.setBandwidthEstimateFromHeaders({ meanEstimate: a });
          });
  ...
  function (a, b, c, d, e, f, g) {
    ...
    a = (function () {
      ...
      b.$17 = function () {
        ...
        if (this.$1.SegmentBase) {
          ...
          b.onError(function (b) {
            var c;
            if ((c = a.$16) == null ? void 0 : c.handleError(a.parseID(), b))
              return;
            return a.$8.emitError(b);
          });
        } else if (this.$1.SegmentTemplate)
          b = this.$18(this.$1.SegmentTemplate[0], { isShared: !1 });
        else if (this.$3) b = this.$18(this.$3[0], { isShared: !0 });
        else {
          e = new (c("oz-player/utils/OzError"))({
            type: "OZ_REPRESENTATION_PARSER",
      ...
      b.$18 = function (a, b) {
        ...
        d =
          (d = this.$12.customRepresentationParsers) == null
            ? void 0
      ...
      b.parseMimeCodecs = function () {
        var a, b;
        a =
          (a = (a = this.$1.$.mimeType) != null ? a : this.$4) != null ? a : "";
        b = (b = (b = this.$1.$.codecs) != null ? b : this.$5) != null ? b : "";
      ...
      b.parseCustomFieldFirstSegment = function () {
        var a = this.$12.customRepresentationParsers
          ? this.$12.customRepresentationParsers.firstSegmentParser
          : null;
      ...
      b.parse = function () {
        return new (c("oz-player/manifests/OzRepresentationBase"))(
          ...
          this.$12.customRepresentationParsers
        );
      };
      return a;
    })();
...
__d(
  ...
  function (a, b, c, d, e, f, g) {
    ...
    a = (function (a) {
      ...
      d.parse = function () {
        var a =
          this.$OzApplicationRepresentationParser3.customRepresentationParsers;
        return new (c("oz-player/manifests/OzApplicationRepresentation"))(
          this.$OzApplicationRepresentationParser1,
          this.$OzApplicationRepresentationParser2,
          this.parseID(),
          this.parseMimeCodecs(),
          this.parseLang(),
          this.parseRole(),
    ...
    a = (function (a) {
      ...
      d.parse = function () {
        ...
        return new (c("oz-player/manifests/OzAudioRepresentation"))(
          ...
          this.$OzAudioRepresentationParser2,
          this.parseID(),
          this.parseMimeCodecs(),
          this.parseLang(),
          this.parseRole(),
    ...
    a = (function (a) {
      ...
      d.parse = function () {
        ...
        return new (c("oz-player/manifests/OzVideoRepresentation"))(
          ...
          this.$OzVideoRepresentationParser2,
          this.parseID(),
          this.parseMimeCodecs(),
          this.parseLang(),
          this.parseRole(),
  ...
  function (a, b, c, d, e, f, g) {
    ...
    a = (function () {
      ...
      b.parse = function (a) {
        ...
        this.$5.getBool("filter_out_source_representation") &&
          (f = f.filter(function (a) {
            return a.getDisplayLabel() !== "Source";
          }));
        f.sort(function (a, b) {
        ...
        this.$9
          ? (g = this.$12(
              this.$13(a, "audio"),
              c("oz-player/parsers/OzAudioRepresentationParser"),
              { manifestType: e, manifestIsTemplated: d }
            ).sort(function (a, b) {
      ...
      b.$15 = function (a, b) {
        return a.find(this.$17(b));
      };
      b.$13 = function (a, b) {
        return a.filter(this.$17(b));
      };
      b.$17 = function (a) {
        return function (b) {
      ...
      b.$14 = function (a, b, c) {
        ...
        return a.Representation.map(function (e) {
          e = new b(
            d.$5,
            e,
            (e = e.ContentProtection) != null ? e : a.ContentProtection,
            d.$4,
            d.$1,
            d.$3,
            c,
        ...
        a.filter(Boolean).forEach(function (a, h, i) {
          ...
          for (
            ...
            n = new b(
              d.$5,
              n,
              (n = n.ContentProtection) != null ? n : a.ContentProtection,
              d.$4,
              d.$1,
              d.$3,
              c,
...
__d(
  ...
  function (a, b, c, d, e, f, g) {
    "use strict";
    g.createTrustedHTMLForDOMParser = d(
      "oz-player/shims/www/OzXmlParserTrustedTypesHTMLPolicyWWW"
      ...
      b.parse = function (a) {
        try {
          var b = h(),
            e = d(
              "oz-player/shims/OzXmlParserTrustedTypesHTMLPolicy"
            ).createTrustedHTMLForDOMParser(a);
    ...
    a = (function () {
      ...
      b.$25 = function (a, b) {
        ...
        if (this.$4.playbackRate === 0) {
          ...
          (g > 0 || h > 0) &&
          b === 0 &&
          (c === 0 || (this.$13 != null && this.$13 + c * 1e3 < Date.now()))
        ) {
          ...
          i > 0 &&
          b === 0 &&
          (this.$12 == null || this.$12 + f * 1e3 < Date.now()) &&
          (c === 0 || (this.$13 != null && this.$13 + c * 1e3 < Date.now()))
        ) {
          h = 1 + i;
          this.$6 == null &&
        ...
        a.then(function () {
          if (e) {
            ...
            if (h) {
              ...
              d(
                "oz-player/loggings/OzLoggingUtils"
              ).monitorPromiseAndLogOperation(k, h, "fetch_stream", l, l);
            }
            return k;
          }
          return null;
    ...
    a = (function (a) {
      ...
      e.updateRunTimeConfigs = function (a) {
        ...
        a === !0 &&
          ...
          (this.$OzMediaStream46(), (this.$OzMediaStream10 = null));
      };
      e.$OzMediaStream48 = function (a, b) {
        var d,
          e = this;
        b === void 0 && (b = "internal");
      ...
      e.$OzMediaStream51 = function () {
        ...
        var j = this.$OzMediaStream56(f, { fetchSingleSegment: e });
        if (j.length === 0) {
          this.$OzMediaStream18
            .cloneContext()
            .getOperationLogger("media_loop_end")
      ...
      e.$OzMediaStream50 = function (a) {
        this.$OzMediaStream19.push(a),
          this.$OzMediaStream6 && this.$OzMediaStream45();
      };
      ...
      e.$OzMediaStream49 = function (a) {
        ...
        if (
          ...
          c("oz-player/shims/ozReportUnexpectedError")(
            ...
            this.$OzMediaStream66(a) && this.$OzMediaStream33.emitError(a);
      };
      ...
      e.$OzMediaStream47 = function (a) {
        this.$OzMediaStream8.getID() === a &&
          ...
          this.$OzMediaStream48(this.$OzMediaStream16.getBestRepresentation());
      };
      e.setEnableLiveheadCatchup = function (a) {
    ...
    a = (function () {
      ...
      b.$6 = function (a, b, c, e, f, g, j, k, l) {
        ...
        if (
          ...
          if (m) {
            if (
              ((o = k == null ? void 0 : k.getSequenceNumber()) != null
                ? o
                : 0) >
              ...
              this.$3
                ...
                .setLength(
                  ((v = k == null ? void 0 : k.getSequenceNumber()) != null
                    ? v
                    : 0) -
                    ((o = (m = u) == null ? void 0 : m.getSequenceNumber()) !=
                    null
                      ? o
                      : 0)
                )
          ...
          s = {
            ...
            mpdStartTime:
              v.length > 0 ? String(v[v.length - 1].startTime) : null,
            mpdEndTime: v.length > 0 ? String(v[v.length - 1].endTime) : null,
          };
          this.$5[l].lastSkippedToSegmentNumber =
            (o = (m = u) == null ? void 0 : m.getSequenceNumber()) != null
              ? o
              : 0;
        }
        ...
        if (u && g && k >= f) {
          n = d("oz-player/streams/OzSegmentLocator").getEndingSequenceNumber(
            a
          );
          return (n || 0) >= k
            ? { segment: g }
    ...
    a = (function (a) {
      ...
      function e(b) {
        ...
        e.$Player10.addSubscriptions(
          e.$Player66.onRepresentationBlocked(function (a) {
        ...
        e.$Player4.getNumber("pixels_below_viewport_to_observe") > 0 &&
          (e.$Player60 = new (c("oz-player/states/OzPositionToViewport"))(
            e.$Player3,
            e.$Player4
          ));
        e.$Player71 = b;
      ...
      f.$Player76 = function (a) {
        ...
        try {
          var e = d("oz-player/loggings/OzLoggingUtils").executeOperationAndLog(
            this.$Player15.cloneContext().setInitiator(this.$Player48),
            "parse_manifest",
            function (e) {
              var f,
                g,
      ...
      f.$Player79 = function (a) {
        ...
        this.$Player66.setAvailableRepresentationsCount(
        ...
        this.$Player18 = new (c(
          ...
          canSupportSkipVideobufferGaps:
            (d =
              (d = this.$Player63) == null
                ? void 0
                : d.getCurrentTimePropertyOverwriteSuccess()) != null
              ? d
              : !1,
      ...
      f.$Player90 = function () {
        this.$Player54 != null &&
          (c("oz-player/shims/ozClearTimeout")(this.$Player54),
          (this.$Player54 = null));
      };
      f.$Player89 = function (a, b) {
        var d = this,
          ...
          g = a.getExtra().code;
        this.$Player55 !== g
          ? ((this.$Player55 = g), (this.$Player56 = 1))
          : this.$Player56++;
        var h = function () {
          e = !1;
        };
        g = {
          ...
          retry: function (a) {
            h(),
              d.$Player90(),
              (d.$Player54 = c("oz-player/shims/ozSetTimeoutAcrossTransitions")(
                function () {
                  d.$Player90(), d.load(b);
                },
      ...
      f.$Player92 = function (a, b) {
        ...
        a = e.then(function (a) {
          c.$Player49 &&
            b !== "caption" &&
            c.$Player49.setSourceBufferState(b, a.getSourceBufferState());
          return a;
        });
        d("oz-player/loggings/OzLoggingUtils").monitorPromiseAndLogOperation(
          a,
      ...
      f.$Player77 = function () {
        if (this.$Player46.length > 0) {
          ...
          this.$Player46 &&
            this.$Player46.forEach(function (b) {
              a.addProvider(b);
            });
        }
      };
      ...
      f.switchToAudioTrack = function (a) {
        ...
        if (b) {
          var d = this.$Player5.get("audio");
          if (d) {
            d.switchRepresentation(b);
            b = 0;
            var e = this.$Player3.duration;
            d.clearSourceBufferRange(b, e)["catch"](function (a) {
              c("oz-player/shims/ozReportUnexpectedError")(
                a,
                "switchToAudioTrack clearSourceBufferRange"
              );
            });
            d.disableAdaptation();
          }
        ...
        if (this.$Player19) {
          ...
          a
            ...
            : this.$Player15
                ...
                .log();
          (b = this.$Player19) == null
            ? void 0
            : b.setTimelineBlockingEnabled(a);
        }
      ...
      f.$Player87 = function () {
        ...
        c = this.$Player2
          ...
          : [
              this.$Player106(),
              this.$Player104({ liveConfigsFromAudioStream: !1 }),
              this.$Player105(),
            ];
        var e = [];
        return b("Promise")
      ...
      f.$Player104 = function (a) {
        ...
        return d.length
          ? this.$Player92(this.$Player110(d) || a, "audio")
          : c("oz-player/shims/OzMaybeNativePromise").resolve();
      };
      ...
      f.destroy = function (a) {
        ...
        "function" === typeof this.$Player3.setMediaKeys &&
          (c = this.$Player3.setMediaKeys(null));
      ...
      f.$Player78 = function (a) {
        var b = new (c("oz-player/parsers/OzMpdParser"))({
          ...
          blockedRepresentationsManager: this.$Player66,
          enableAlternativeAudioTracks: this.$Player4.getBool(
      ...
      f.$Player91 = function (a) {
        ...
        if (!c) {
          ...
          c.updateLocation(a);
          this.$Player42 &&
            (this.$Player10.releaseOne(this.$Player42),
            (this.$Player42 = null));
          a = function () {
            b.$Player42 &&
              (b.$Player10.releaseOne(b.$Player42), (b.$Player42 = null)),
      ...
      f.$Player114 = function (a, b) {
        ...
        this.$Player57 === a
          ? (b =
              (c("oz-player/shims/OzPerformance").now() -
                Number(this.$Player58)) /
              1e3)
          : ((this.$Player58 = c("oz-player/shims/OzPerformance").now()),
            (this.$Player57 = a));
  ...
  function (a, b, c, d, e, f, g) {
    a = (function () {
      function a(a, b) {
        ...
        this.$2 = b;
        this.$3.addSubscriptions(
          c("EventListener").listen(this.$1, "playing", function () {
            return d.$5();
          }),
...
__d(
  "OzConfigurableRequestImplementation",
  [
    "MaybeNativePromise",
    "oz-player/networks/OzHTTPHeaders",
    "oz-player/utils/arrayBuffer2OzReadableStream",
...
__d(
  "OzMaximumDimensionsRestriction",
  [],
  function (a, b, c, d, e, f) {
    "use strict";
    a = (function () {
...
__d(
  "P2PPlaybackSessionLogger",
  ["LiveVideoWorkplaceP2PPlaybackTypedLogger", "Random"],
  function (a, b, c, d, e, f, g) {
    "use strict";
    a = (function () {
      function a(a, b) {
      ...
      b.setCurrentHiveStats = function (a) {
        (this.$3 = a),
          !this.$4 &&
            a.p2pRequests > 0 &&
            ((this.$4 = !0), this.logReceivedFirstPeerRequest());
      };
      ...
      b.$8 = function () {
        this.$5 ||
          (this.$5 = window.setInterval(this.logStats.bind(this), 60 * 1e3));
      };
      b.$9 = function () {
        return new (c("LiveVideoWorkplaceP2PPlaybackTypedLogger"))()
          .setVideoID(this.$1)
          .setCommunityID(this.$7.communityId)
          .setCommunityName(this.$7.communityName)
          .setSessionID(this.$2)
          .setTimeMs(Date.now());
      };
      ...
      b.logSessionInit = function (a, b) {
        (this.$6 = Date.now()),
          this.$9()
            .setEventStr("SESSION_INITIALIZED")
            .setHivePluginTech(a)
            .setViewerManifestURL(b)
            .log();
      };
      ...
      b.logError = function (a) {
        this.$9()
          .setEventStr("ERROR")
          .setExceptionTrace(a.stack)
          .setExceptionMessage(a.message)
          .setExceptionType(a.name)
          .log();
      };
      b.logHiveError = function (a) {
        this.$9()
          .setEventStr("HIVE_ERROR")
          .setExceptionMessage(a.message)
          .setExceptionType("HiveErrorMessage")
          .setExceptionCode(a.code)
          .setExceptionSeverity(a.severity)
          .log();
      };
      b.logUnload = function () {
        ...
        b &&
          a
            .setHiveClientStatsCdnRequests(b.cdnRequests)
            .setHiveClientStatsCdnResponseBytes(b.cdnResponseBytes)
            .setHiveClientStatsCdnResponseErrors(b.cdnResponseErrors)
            .setHiveClientStatsCdnResponses(b.cdnResponses)
            .setHiveClientStatsP2pRequests(b.p2pRequests)
            .setHiveClientStatsP2pResponseBytes(b.p2pResponseBytes)
            .setHiveClientStatsP2pResponseErrors(b.p2pResponseErrors)
            .setHiveClientStatsP2pResponses(b.p2pResponses)
            .setHiveClientStatsSavings(parseInt(b.savings, 10))
            .setHiveClientStatsNumPartners(Object.keys(b.partners).length);
        a.log();
      };
      ...
      b.logStats = function () {
        ...
        a &&
          b
            .setHiveClientStatsCdnRequests(a.cdnRequests)
            .setHiveClientStatsCdnResponseBytes(a.cdnResponseBytes)
            .setHiveClientStatsCdnResponseErrors(a.cdnResponseErrors)
            .setHiveClientStatsCdnResponses(a.cdnResponses)
            .setHiveClientStatsP2pRequests(a.p2pRequests)
            .setHiveClientStatsP2pResponseBytes(a.p2pResponseBytes)
            .setHiveClientStatsP2pResponseErrors(a.p2pResponseErrors)
            .setHiveClientStatsP2pResponses(a.p2pResponses)
            .setHiveClientStatsSavings(parseInt(a.savings, 10))
            .setHiveClientStatsNumPartners(Object.keys(a.partners).length);
        b.log();
      };
    ...
    b = (function (a) {
      ...
      b.isEnabled = function () {
        return (
          ...
          b.$ExtendableVideoPlayerShakaPerformanceTypedLogger6()
        );
      };
      b.disable = function () {
        l = !1;
      ...
      b.flushQueuedLogs = function () {
        ...
        if (!b.isEnabled()) {
          ...
          b.enable();
          for (var a = k; a <= h; ++a)
            b.$ExtendableVideoPlayerShakaPerformanceTypedLogger7(a);
          for (a = 0; a < k; ++a)
            b.$ExtendableVideoPlayerShakaPerformanceTypedLogger7(a);
          j = [];
          k = 0;
      ...
      e.$ExtendableVideoPlayerShakaPerformanceTypedLogger8 = function () {
        m && this.setIsRingBufferSample(!0),
          this.$ExtendableVideoPlayerShakaPerformanceTypedLogger9();
      };
      e.log = function () {
        b.isEnabled() ||
        (this.$ExtendableVideoPlayerShakaPerformanceTypedLogger4 || 0) > 0
    ...
    a = (function (a) {
      ...
      function b(c) {
        ...
        e.$VideoPlayerShakaPerformanceLogger30 =
          (d = c.getPlayerFormat) != null ? d : null;
        ...
        e.$VideoPlayerShakaPerformanceLogger35 =
      ...
      e.$VideoPlayerShakaPerformanceLogger39 = function (a) {
        ...
        if (e != null) {
          ...
          f != null &&
            (a = a
              .setLastAudioBufferedStart(f.lastBufferedStart)
              .setLastAudioBufferedEnd(f.lastBufferedEnd));
        }
        ...
        if (b != null) {
          ...
          d != null &&
            (a = a
              .setLastVideoBufferedStart(d.lastBufferedStart)
              .setLastVideoBufferedEnd(d.lastBufferedEnd));
        }
        return a;
      };
      ...
      e.addToLastErrorQueue = function (a) {
        this.$VideoPlayerShakaPerformanceLogger27.push(a),
          this.$VideoPlayerShakaPerformanceLogger27.length > j &&
            this.$VideoPlayerShakaPerformanceLogger27.shift();
      };
      e.getEventLogger = function (a) {
        var e = this,
          ...
          j = this.$VideoPlayerShakaPerformanceLogger28(
            this.$VideoPlayerShakaPerformanceLogger11
          ),
          k =
            this.$VideoPlayerShakaPerformanceLogger24.getApproximateFBLSToPlayerDisplayLatency(),
          l = this.$VideoPlayerShakaPerformanceLogger29
            ? this.$VideoPlayerShakaPerformanceLogger29()
            : null;
        this.$VideoPlayerShakaPerformanceLogger39(g)
          .setEvent(a)
          ...
          .setDynamicBitrate(this.$VideoPlayerShakaPerformanceLogger22)
          ...
          .setPlayerOriginCallerSpecified(
            this.$VideoPlayerShakaPerformanceLogger16
          )
          .setScriptPath(d("ScriptPath").getScriptPath())
          .setPlayerHeight(l ? l.height : null)
          .setPlayerWidth(l ? l.width : null)
          .setPlayerSuborigin(this.$VideoPlayerShakaPerformanceLogger17)
          .setPlayerVersion(this.$VideoPlayerShakaPerformanceLogger18)
          .setPlayerFormat(
            this.$VideoPlayerShakaPerformanceLogger30
              ? this.$VideoPlayerShakaPerformanceLogger30()
              : null
          )
          ...
          .setManifestType(this.$VideoPlayerShakaPerformanceLogger20)
          ...
          .setResult("success")
          .setAccessToken(this.$VideoPlayerShakaPerformanceLogger15)
          .setVideoPlaybackExperienceIssue(
            b.$VideoPlayerShakaPerformanceLogger31
          )
          .setClientTimeBegin(f)
          .setClientTimeDuration(0)
          .setClientTimeEnd(f)
          .setIsDrm(this.$VideoPlayerShakaPerformanceLogger32)
          .setPlayerInstanceCount(this.$VideoPlayerShakaPerformanceLogger35)
          .setFblsToPlyDisMs(
            (k == null ? void 0 : k.latencyFromMpdUpdate) != null
              ? Math.round(k.latencyFromMpdUpdate * 1e3)
              : null
          )
          .setPreferredEdgeLatency(this.$VideoPlayerShakaPerformanceLogger19)
          .setPerSessionSampleRate(
            this.$VideoPlayerShakaPerformanceLogger24.perSessionSampleRate
          )
          .setIsLatencyCachupEnabled(this.$VideoPlayerShakaPerformanceLogger14)
          .setIsOnline(this.$VideoPlayerShakaPerformanceLogger33);
        switch (a) {
          case "buffering":
        ...
        g.setState = function (a) {
          this;
          a !== m.$VideoPlayerShakaPerformanceLogger5 && a === "playing"
          ...
          if (typeof a === "object" && a != null)
            if (a instanceof c("oz-player/utils/OzError"))
              this.setResult("failed"),
                ...
                m.addToLastErrorQueue(a.getType()),
              ...
              if (a.type === "aborted" || a.type === "delay")
                ...
                if (a.type != null && a.type !== "")
                  m.addToLastErrorQueue(a.type), o.call(this, a.type);
                else {
                  var b = function (a) {
                    return a.replace(/([0-9]{2,})/g, function (a) {
                      var b = "";
      ...
      e.createOperationLogger = function (a) {
        ...
        b.log = function () {
          ...
          h = b.getType();
          h &&
            ((f.$VideoPlayerShakaPerformanceLogger34[h + a] =
              (f.$VideoPlayerShakaPerformanceLogger34[h + a] || 0) + 1),
      ...
      e.$VideoPlayerShakaPerformanceLogger40 = function (a) {
        if (
          a == null ||
          i === 0 ||
          this.$VideoPlayerShakaPerformanceLogger25 === 0 ||
          a < i ||
          this.$VideoPlayerShakaPerformanceLogger26 < a
        ) {
      ...
      e.setDynamicBitrate = function (a) {
        this.$VideoPlayerShakaPerformanceLogger22 =
  ...
  function (a, b, c, d, e, f, g) {
    ...
    function a(a, b) {
      ...
      switch (a) {
        ...
        case "UHD":
          c("gkx")("3728") &&
            d.push(new (c("OzMinimumSmallestDimensionRestriction"))(1080));
          break;
        default:
          break;
      }
  ...
  function (a, b, c, d, e, f, g) {
    ...
    a = (function (a) {
      ...
      e.isSupported = function (a) {
        var e;
        !a.hasDashManifest() && !a.getLiveManifestUrl()
          ? (e = "noDashManifest")
          : !window.MediaSource
          ? (e = "noMediaSourceSupport")
          : !window.fetch && !b("cr:1934445")
          ? (e = "noFetch")
          : !d("oz-player/shims/OzStreams").OzReadableStream ||
            !d("oz-player/shims/OzStreams").OzReadableStream.prototype.pipeTo ||
            !d("oz-player/shims/OzStreams").OzReadableStream.prototype
              .pipeThrough
          ? (e = "noReadableStream")
          : !d("oz-player/shims/OzStreams").OzWritableStream
          ? (e = "noWritableStream")
          : c("manifestHasUnsupportedCodecs")(a.getDashManifest()) &&
            (e = "codecNotSupported");
        if (e) {
          d("ODS").bumpEntityKey(2966, "VideoPlayerHtml5Oz", "fallback." + e);
          return !1;
        }
        return !0;
      };
      ...
      function e(b, d, e) {
        ...
        f.$VideoPlayerHTML5Oz15 = null;
        f.$VideoPlayerHTML5Oz22 = !1;
        f.$VideoPlayerHTML5Oz23 = !1;
        f.$VideoPlayerHTML5Oz24 = null;
        f.$VideoPlayerHTML5Oz25 = null;
        f.$VideoPlayerHTML5Oz26 = !1;
        f.$VideoPlayerHTML5Oz27 = !1;
        f.$VideoPlayerHTML5Oz30 = !0;
        f.$VideoPlayerHTML5Oz31 = !1;
        f.$VideoPlayerHTML5Oz42 = null;
        f.$VideoPlayerHTML5Oz46 = null;
        f.$VideoPlayerHTML5Oz47 = !1;
        f.$VideoPlayerHTML5Oz48 = null;
        f.$VideoPlayerHTML5Oz1 = b;
        f.$VideoPlayerHTML5Oz2 = h;
        f.$VideoPlayerHTML5Oz3 = new (c("VideoPlayerOzWWWConfig"))(g);
        f.$VideoPlayerHTML5Oz16 = d;
        f.$VideoPlayerHTML5Oz13 = i;
        f.$VideoPlayerHTML5Oz14 = q;
        f.$VideoPlayerHTML5Oz17 = j;
        f.$VideoPlayerHTML5Oz18 = t;
        f.$VideoPlayerHTML5Oz19 = u;
        f.$VideoPlayerHTML5Oz20 = w;
        f.$VideoPlayerHTML5Oz28 = x;
        f.$VideoPlayerHTML5Oz29 = y;
        f.$VideoPlayerHTML5Oz32 = z;
        f.$VideoPlayerHTML5Oz33 = m;
        f.$VideoPlayerHTML5Oz34 = A;
        f.$VideoPlayerHTML5Oz35 = B;
        f.$VideoPlayerHTML5Oz36 = C;
        f.$VideoPlayerHTML5Oz37 = D;
        f.$VideoPlayerHTML5Oz38 = E;
        f.$VideoPlayerHTML5Oz26 = k;
        f.$VideoPlayerHTML5Oz47 = (h = e) != null ? h : !1;
        (typeof r === "number" || typeof s === "number") &&
          (f.$VideoPlayerHTML5Oz15 = new (c("OzMaximumDimensionsRestriction"))({
            maxHeight: (typeof r === "number" ? r : null) || Infinity,
            maxWidth: (typeof s === "number" ? s : null) || Infinity,
          }));
        F &&
          ((f.$VideoPlayerHTML5Oz48 = F.community_info),
          (f.$VideoPlayerHTML5Oz39 = F.ticket),
          (f.$VideoPlayerHTML5Oz43 = F.hive_initialization_options),
          (f.$VideoPlayerHTML5Oz40 = F.config),
          f.$VideoPlayerHTML5Oz40 &&
            (f.$VideoPlayerHTML5Oz40.delay_p2p_until_play = !1),
          f.$VideoPlayerHTML5Oz49());
        f.$VideoPlayerHTML5Oz47
          ? (f.$VideoPlayerHTML5Oz8 = null)
          : (f.$VideoPlayerHTML5Oz8 = c(
              "VideoPlayerShakaPerformanceLogger"
            ).shouldInitialize()
              ? new (c("VideoPlayerShakaPerformanceLogger"))({
                  videoID: j,
                  video: b,
                  ...
                  getBandwidthEstimate: function (a) {
                    return c(
                      "oz-player/networks/OzBandwidthEstimator"
                    ).getAdjustedBandwidth(f.$VideoPlayerHTML5Oz3);
                  },
              ...
              : null);
        f.$VideoPlayerHTML5Oz8 &&
          (f.$VideoPlayerHTML5Oz21 = new (c("VideoPlayerPlayLogger"))(
            f.$VideoPlayerHTML5Oz1,
            f.$VideoPlayerHTML5Oz8
          ));
        f.$VideoPlayerHTML5Oz12 = v;
        (!f.$VideoPlayerHTML5Oz14 ||
          typeof f.$VideoPlayerHTML5Oz14.getCachedRepresentations !==
            "function") &&
          (f.$VideoPlayerHTML5Oz14 = null);
        !f.$VideoPlayerHTML5Oz14 &&
          f.$VideoPlayerHTML5Oz3.getBool("use_prefetch_cache", !1) &&
          (f.$VideoPlayerHTML5Oz14 = new (c("OzDashPrefetchCache"))());
        f.$VideoPlayerHTML5Oz50();
        return f;
      }
      var f = e.prototype;
      f.$VideoPlayerHTML5Oz50 = function () {
        var a = this;
        this.$VideoPlayerHTML5Oz11 = new (c("SubscriptionsHandler"))();
        this.$VideoPlayerHTML5Oz51();
        this.$VideoPlayerHTML5Oz11.addSubscriptions(
          c("EventListener").listen(
            this.$VideoPlayerHTML5Oz1,
            "timeupdate",
            function (b) {
              a.$VideoPlayerHTML5Oz52(b.target.currentTime);
            }
          )
        );
      };
      f.setup = function () {
        var a = [];
        this.$VideoPlayerHTML5Oz8 && a.push(this.$VideoPlayerHTML5Oz8);
        var b = [];
        this.$VideoPlayerHTML5Oz3.getBool("force_initial_representation", !1) &&
          (b = this.$VideoPlayerHTML5Oz16);
        this.$VideoPlayerHTML5Oz53({
          manifest: this.$VideoPlayerHTML5Oz2,
          manifestUrl: this.$VideoPlayerHTML5Oz13,
          loggerProviders: a,
          prefetchCache: this.$VideoPlayerHTML5Oz14,
          initialRepresentations: b,
          videoID: this.$VideoPlayerHTML5Oz17,
          width: this.$VideoPlayerHTML5Oz18,
          height: this.$VideoPlayerHTML5Oz19,
        });
      };
      f.$VideoPlayerHTML5Oz53 = function (a) {
        var e = this,
          ...
          h = a.loggerProviders,
          j = a.prefetchCache,
          k = a.initialRepresentations;
        a = a.videoID;
        var l = this.$VideoPlayerHTML5Oz54(),
          m = null;
        switch (this.$VideoPlayerHTML5Oz12) {
          case "hd":
          case "HD":
            m = "HD";
            break;
        ...
        this.$VideoPlayerHTML5Oz46 = this.$VideoPlayerHTML5Oz44
          ? c("OzConfigurableRequestImplementation")(
              this.$VideoPlayerHTML5Oz44.getRequestImplementation(),
              { inferResponseStatusIsOK: !0, inferResponseStatusIsOk2xx: !1 }
            )
          : null;
        m = c("getOzPlaybackRestrictions")(m, this.$VideoPlayerHTML5Oz3);
        this.$VideoPlayerHTML5Oz15 && m.push(this.$VideoPlayerHTML5Oz15);
        var n = (this.$VideoPlayerHTML5Oz4 = new (c("oz-player"))({
          videoNode: this.$VideoPlayerHTML5Oz1,
          config: d(
            "oz-player/configs/OzConfigUtils"
          ).provideConfigWithDefaults(this.$VideoPlayerHTML5Oz3),
          rawMpdXml:
            f === "" &&
            this.$VideoPlayerHTML5Oz3.getBool(
              "blue_video_player_pass_inline_mpd_xml_empty_string_as_undefined",
              !1
            )
              ? void 0
              : f,
          customSegmentTimelineParser: this.$VideoPlayerHTML5Oz3.getBool(
            "enable_predictive_dash",
            !1
          )
          ...
          networkRequestStreamHandlers: [
            new (c("OzActiveActiveFailoverNetworkRequestStreamHandler"))(
              function (a, b) {
                var d = a.headers;
                a = a.status;
                a = c("oz-player/networks/createNetworkError")(
                  new Error("Replica switch requested via HTTP headers"),
                  a,
                  d,
                  b,
                  "HTTP error."
            ...
            new (c("OzVideoLiveTraceNetworkRequestStreamHandler"))(function (
              ...
              e.$VideoPlayerHTML5Oz29 &&
                e.$VideoPlayerHTML5Oz29.handleHeadersAndBody(a, b, c);
            },
            this.$VideoPlayerHTML5Oz3.getBool("live_trace_parse_emsg", !1)),
            new (c(
              "oz-player/networks/OzClockSyncNetworkRequestStreamHandler"
            ))(),
          ],
          getShouldIncludeCredentials: this.$VideoPlayerHTML5Oz3.getBool(
          ...
          getOverrideOzRequestImplementation: function () {
            var a,
              c =
                !window.fetch ||
                e.$VideoPlayerHTML5Oz3.getBool(
                  "blue_video_player_force_xhr",
                  !1
                )
                  ? b("cr:1934445")
                  : null;
            return (a = (a = e.$VideoPlayerHTML5Oz46) != null ? a : c) != null
              ? a
              : null;
          },
          initialRepresentationIDs: k || [],
          customParsers: d("OzCustomParsers").createOzCustomParser(),
          entityKey: a,
          videoPlaybackRestrictions: m,
          customRepresentationParsers: d(
            "OzCustomRepresentationParsers"
          ).createOzCustomRepresentationParsers({
            ozConfig: this.$VideoPlayerHTML5Oz3,
            startTimestamp: this.$VideoPlayerHTML5Oz20,
          }),
          seekHandler: this.$VideoPlayerHTML5Oz28,
          initialPlaybackPositionForDynamicMpd:
            this.$VideoPlayerHTML5Oz37 != null && this.$VideoPlayerHTML5Oz37 > 0
              ? (this.$VideoPlayerHTML5Oz37 / 1e3) * -1
              : this.$VideoPlayerHTML5Oz3.getNumber(
                  "live_initial_playback_position",
                  0
                ),
          liveheadFallBehindBlockThreshold:
            this.$VideoPlayerHTML5Oz37 != null &&
            this.$VideoPlayerHTML5Oz37 > 0 &&
            this.$VideoPlayerHTML5Oz38 != null &&
            this.$VideoPlayerHTML5Oz38 > 0
              ? (this.$VideoPlayerHTML5Oz37 + this.$VideoPlayerHTML5Oz38) / 1e3
              : this.$VideoPlayerHTML5Oz3.getNumber(
                  "livehead_fall_behind_block_threshold",
                  0
                ),
          liveheadFallBehindBlockMargin:
            this.$VideoPlayerHTML5Oz37 != null && this.$VideoPlayerHTML5Oz37 > 0
              ? this.$VideoPlayerHTML5Oz37 / 2 / 1e3
              : this.$VideoPlayerHTML5Oz3.getNumber(
                  "live_time_range_block_margin",
                  0
                ),
          startTimeStamp: this.$VideoPlayerHTML5Oz3.getBool(
            "fix_start_timestamp",
            !1
          )
            ? this.$VideoPlayerHTML5Oz20 || 0
            : 0,
          drmProviders: l,
          getVideoDimensions: function () {
            return {
              height: e.$VideoPlayerHTML5Oz19,
              width: e.$VideoPlayerHTML5Oz18,
            };
          },
        }));
        this.$VideoPlayerHTML5Oz11.addSubscriptions(
          n.onError(this.$VideoPlayerHTML5Oz55.bind(this)),
          n.addListener("destroyed", this.$VideoPlayerHTML5Oz56.bind(this)),
          n.addListener(
            "debug/dashPlayerEvent",
            this.$VideoPlayerHTML5Oz57.bind(this)
          ),
          n.addListener("streamEnd", this.$VideoPlayerHTML5Oz58.bind(this)),
          n.addListener("manifestFetchError", function (a) {
        ...
        this.$VideoPlayerHTML5Oz11.addSubscriptions(
          n.addListener(
            "enterBuffering",
            this.$VideoPlayerHTML5Oz59.bind(this)
          ),
          n.addListener("leaveBuffering", this.$VideoPlayerHTML5Oz60.bind(this))
        );
        if (
          this.$VideoPlayerHTML5Oz39 &&
          this.$VideoPlayerHTML5Oz26 &&
          this.$VideoPlayerHTML5Oz40
        )
          if (
            !this.$VideoPlayerHTML5Oz40.delay_p2p_until_play ||
            this.$VideoPlayerHTML5Oz41
          )
            this.$VideoPlayerHTML5Oz61();
          else {
            f = function a() {
              e.$VideoPlayerHTML5Oz1.removeEventListener("play", a),
                e.$VideoPlayerHTML5Oz61();
            };
            h = function a() {
              e.$VideoPlayerHTML5Oz1.removeEventListener("ended", a),
                e.disableP2PPlayback();
            };
            this.$VideoPlayerHTML5Oz1.addEventListener("play", f);
            this.$VideoPlayerHTML5Oz1.addEventListener("ended", h);
          }
        this.$VideoPlayerHTML5Oz11.addSubscriptions(
          n.addListener("mpdReady", function (a) {
            e.$VideoPlayerHTML5Oz62(a);
          })
        );
        this.$VideoPlayerHTML5Oz42
          ? this.$VideoPlayerHTML5Oz42
              .then(function () {
                var a = e.$VideoPlayerHTML5Oz13;
                n.load(a);
              })
              ["catch"](function () {
                (e.$VideoPlayerHTML5Oz13 = g),
                  e.disableP2PPlayback(),
                  n.load(g);
              })
          : n.load(g);
      };
      f.$VideoPlayerHTML5Oz62 = function (a) {
        this.ispDASH() &&
          (this.$VideoPlayerHTML5Oz3.setContext("latency_level", "predictive"),
          this.$VideoPlayerHTML5Oz3.setContext(
            "streaming_implementation",
            "pdash"
          )),
          this.$VideoPlayerHTML5Oz63(this.$VideoPlayerHTML5Oz4),
          this.$VideoPlayerHTML5Oz64(a),
          this.$VideoPlayerHTML5Oz29 && this.$VideoPlayerHTML5Oz65(a),
          this.$VideoPlayerHTML5Oz3.getBool("update_seekable_range", !1) &&
            this.$VideoPlayerHTML5Oz66(a);
      };
      f.$VideoPlayerHTML5Oz49 = function () {
        var a = this,
          b = this.$VideoPlayerHTML5Oz45;
        if (b == null) {
          var d;
          this.$VideoPlayerHTML5Oz45 = b = new (c("P2PPlaybackSessionLogger"))(
            this.$VideoPlayerHTML5Oz17,
            {
              communityId:
                (d =
                  (d = this.$VideoPlayerHTML5Oz48) == null
                    ? void 0
                    : d.community_id) != null
                  ? d
                  : "unknowncustomer",
        ...
        try {
          var e;
          b.logEnableP2P();
          d = this.$VideoPlayerHTML5Oz43 ? this.$VideoPlayerHTML5Oz43 : {};
          d.debugLevel = (e = d.debugLevel) != null ? e : "debug";
          d.hiveTechOrder =
            (e = d.hiveTechOrder) != null
              ? e
              : ["HiveJS", "StatsJS", "HiveJava"];
          e = d.HiveJS ? d.HiveJS : {};
          e.renderStatsCallback = function (b) {
            a.emit("debug/dashPlayerEvent", { type: "P2PStats", event: b }),
              c("nullthrows")(a.$VideoPlayerHTML5Oz45).setCurrentHiveStats(b);
          };
          d.onActiveSession = function (b) {
            a.$VideoPlayerHTML5Oz45 &&
              a.$VideoPlayerHTML5Oz45.logSessionActive(b.tech),
          ...
          var f =
              d.hiveTechOrder != null
                ? d.hiveTechOrder.indexOf("HiveJava")
                : -1,
            g = this.$VideoPlayerHTML5Oz40;
          g &&
            (g.disable_hivejava_for_livevc &&
              this.$VideoPlayerHTML5Oz13 &&
              this.$VideoPlayerHTML5Oz13.startsWith(
                "https://livestream-lookaside"
              ) &&
              d.hiveTechOrder &&
              f !== -1 &&
              d.hiveTechOrder.splice(f, 1),
            (d.HiveJS = e),
            (d.telemetryId = b.getSessionID()),
            (d.onError = this.$VideoPlayerHTML5Oz67.bind(this)),
            (this.$VideoPlayerHTML5Oz44 = new window.HiveOz(d)));
        } catch (a) {
          b.logError(a), (this.$VideoPlayerHTML5Oz41 = void 0);
        }
      };
      f.$VideoPlayerHTML5Oz61 = (function () {
        var a = b("asyncToGeneratorRuntime").asyncToGenerator(function* () {
          var a = this,
            b = this.$VideoPlayerHTML5Oz44,
            d = this.$VideoPlayerHTML5Oz45,
            e = new (c("Deferred"))(c("MaybeNativePromise"));
          try {
            if (b != null) {
              this.$VideoPlayerHTML5Oz3.getBool(
                "fix_oz_p2p_enable_failed",
                !1
              ) || (this.$VideoPlayerHTML5Oz42 = e.getPromise());
              window.HiveConfig.SensitiveInfo.restrictedConnectivityInfo = !0;
              if (!this.$VideoPlayerHTML5Oz13) return;
              var f = this.$VideoPlayerHTML5Oz13.substring(
                this.$VideoPlayerHTML5Oz13.indexOf("?")
              );
              this.$VideoPlayerHTML5Oz3.getBool(
                "fix_oz_p2p_enable_failed",
                !1
              ...
              b = b.initSession(
                c("nullthrows")(this.$VideoPlayerHTML5Oz39) + f,
                this.$VideoPlayerHTML5Oz4,
                this.$VideoPlayerHTML5Oz1
              );
              f = this.$VideoPlayerHTML5Oz41 = yield b;
              this.$VideoPlayerHTML5Oz13 = f.manifest;
              b.then(
                function (a) {
                  return e.resolve(a);
                },
                ...
                a.$VideoPlayerHTML5Oz42 = null;
              });
              f.manifest != this.$VideoPlayerHTML5Oz13 &&
                d &&
                d.logManifestMismatch(f.manifest, this.$VideoPlayerHTML5Oz13);
              d && d.logSessionInit(f.tech, this.$VideoPlayerHTML5Oz13);
            }
          } catch (a) {
            this.$VideoPlayerHTML5Oz3.getBool("fix_oz_p2p_enable_failed", !1) &&
              e.reject(a),
              d && d.logError(a),
              (this.$VideoPlayerHTML5Oz41 = void 0);
          }
        });
        function d() {
          return a.apply(this, arguments);
      ...
      f.$VideoPlayerHTML5Oz67 = function (a) {
        this.$VideoPlayerHTML5Oz45 &&
          this.$VideoPlayerHTML5Oz45.logHiveError(a);
      };
      f.disableP2PPlayback = function () {
        try {
          this.$VideoPlayerHTML5Oz45 &&
            this.$VideoPlayerHTML5Oz45.logEndSession(),
            this.$VideoPlayerHTML5Oz44 &&
              this.$VideoPlayerHTML5Oz44.closeHiveSession();
        } catch (a) {
          c("FBLogger")("www_p2p_playback").warn(a.message);
        }
        this.$VideoPlayerHTML5Oz4 &&
          this.$VideoPlayerHTML5Oz3.getBool(
            "unset_override_oz_request_implementation_on_hive_error",
            !1
          ) &&
          (this.$VideoPlayerHTML5Oz46 = null);
        this.$VideoPlayerHTML5Oz45 = null;
        this.$VideoPlayerHTML5Oz44 = null;
        this.$VideoPlayerHTML5Oz41 = null;
        this.$VideoPlayerHTML5Oz39 = null;
      };
      f.$VideoPlayerHTML5Oz66 = function (a) {
        var b = this;
        this.$VideoPlayerHTML5Oz11.addSubscriptions(
          a.addListener("updated", function () {
            b.emit("seekRangeChanged");
          })
        );
      };
      f.$VideoPlayerHTML5Oz54 = function () {
        var a = [];
        this.$VideoPlayerHTML5Oz32 &&
          a.push(
            new this.$VideoPlayerHTML5Oz32.OzWidevineDrmProviderModule(
              this.$VideoPlayerHTML5Oz17,
              this.$VideoPlayerHTML5Oz35,
              this.$VideoPlayerHTML5Oz34,
              this.$VideoPlayerHTML5Oz33,
              this.$VideoPlayerHTML5Oz36
            )
          );
        return a;
      };
      f.$VideoPlayerHTML5Oz68 = function () {
        var a = this;
        return function (b, c) {
          if (!a.$VideoPlayerHTML5Oz6 || !a.$VideoPlayerHTML5Oz30) return;
          try {
            ...
            a.$VideoPlayerHTML5Oz55(b);
          }
        };
      };
      f.$VideoPlayerHTML5Oz52 = function (a) {
        if (
          this.$VideoPlayerHTML5Oz3.getBool(
            "fix_representation_ended_timing",
            !1
          ) &&
          (this.$VideoPlayerHTML5Oz1.paused ||
            this.$VideoPlayerHTML5Oz1.seeking)
        )
          return;
        if (!this.$VideoPlayerHTML5Oz4) return;
        a = this.$VideoPlayerHTML5Oz4.getVideoRepresentationIDAtTime(a);
        if (a != null && a !== this.$VideoPlayerHTML5Oz7) {
          var b = this.$VideoPlayerHTML5Oz7;
          this.$VideoPlayerHTML5Oz7 = a;
          b != null &&
            this.emit("representation_ended", {
              representationID: b,
              nextRepresentationID: a,
            });
        }
      };
      f.$VideoPlayerHTML5Oz51 = function () {
        var a = this,
          b = this.$VideoPlayerHTML5Oz3.getNumber(
            "connection_quality_context_throttle_frequency",
            0
          );
        if (b === 0) return;
        var f = function () {
          a.$VideoPlayerHTML5Oz3.setContext(
            "connection_quality",
            d("VideoPlayerConnectionQuality").evaluate(e.getEstimatedBandwidth)
          );
        };
        this.$VideoPlayerHTML5Oz11.addSubscriptions(
          c("oz-player/networks/OzBandwidthEstimator").addListener(
            "bandwidth_sampled",
            c("throttle")(f, b)
          )
        );
      ...
      f.$VideoPlayerHTML5Oz55 = function (a) {
        if (a instanceof c("oz-player/utils/OzError")) {
          var b = a.getExtra();
          this.disableP2PPlayback();
          (b.code === "417" || b.code === "200") &&
          b.headers &&
          b.headers.has("x-fb-video-replica")
            ? this.emit("replicaSwitch", {
                replica: parseInt(b.headers.get("x-fb-video-replica"), 10),
                url: b.url,
                status: b.code,
                timestamp: new Date().valueOf(),
              })
            : (this.emit("error", c("reportOzError")(a)),
              this.$VideoPlayerHTML5Oz4 && this.$VideoPlayerHTML5Oz4.destroy());
        } else this.emit("error", c("reportOzError")(a));
      };
      f.$VideoPlayerHTML5Oz58 = function () {
        this.$VideoPlayerHTML5Oz27 = !0;
      };
      f.$VideoPlayerHTML5Oz56 = function () {
        this.$VideoPlayerHTML5Oz4 = null;
      };
      f.$VideoPlayerHTML5Oz57 = function (a) {
        this.emit("debug/dashPlayerEvent", a.detail);
      };
      f.$VideoPlayerHTML5Oz69 = function () {
        var a = 1;
        return (this.$VideoPlayerHTML5Oz24 != null &&
          Math.abs(
            this.$VideoPlayerHTML5Oz1.currentTime - this.$VideoPlayerHTML5Oz24
          ) < a) ||
          (this.$VideoPlayerHTML5Oz25 != null &&
            Math.abs(
              this.$VideoPlayerHTML5Oz1.currentTime - this.$VideoPlayerHTML5Oz25
            ) < a)
          ? !0
          : !1;
      };
      f.$VideoPlayerHTML5Oz59 = function (a) {
        this.$VideoPlayerHTML5Oz69() ||
          ((this.$VideoPlayerHTML5Oz22 = !0),
          this.emit("bufferingStart"),
          this.$VideoPlayerHTML5Oz8 &&
            (this.$VideoPlayerHTML5Oz9 = this.$VideoPlayerHTML5Oz8
              .getOperationLogger("buffering")
              .setType(a)
              .start())),
          this.$VideoPlayerHTML5Oz3.getBool(
            "throttle_playback_rate_on_stall",
            !1
          ) && this.$VideoPlayerHTML5Oz70();
      };
      f.$VideoPlayerHTML5Oz60 = function () {
        (!this.$VideoPlayerHTML5Oz3.getBool(
          "buffer_end_only_when_buffering",
          !1
        ) ||
          this.$VideoPlayerHTML5Oz22) &&
          (this.emit("bufferingEnd"),
          this.$VideoPlayerHTML5Oz9 &&
            (this.$VideoPlayerHTML5Oz9.log(),
            (this.$VideoPlayerHTML5Oz9 = null)),
          (this.$VideoPlayerHTML5Oz22 = !1)),
          this.$VideoPlayerHTML5Oz3.getBool(
            "throttle_playback_rate_on_stall",
            !1
          ) && this.$VideoPlayerHTML5Oz71();
      };
      f.$VideoPlayerHTML5Oz70 = function () {
        this.$VideoPlayerHTML5Oz5 == null &&
          (this.$VideoPlayerHTML5Oz5 = this.$VideoPlayerHTML5Oz1.playbackRate),
          (this.$VideoPlayerHTML5Oz1.playbackRate = 0);
      };
      f.$VideoPlayerHTML5Oz71 = function () {
        this.$VideoPlayerHTML5Oz5 &&
          (this.$VideoPlayerHTML5Oz1.playbackRate = this.$VideoPlayerHTML5Oz5),
          (this.$VideoPlayerHTML5Oz5 = null);
      };
      f.$VideoPlayerHTML5Oz65 = function (a) {
        var b = this,
          c = function () {
            if (b.$VideoPlayerHTML5Oz29) {
              var c = a.getCustomField("loapStreamType");
              typeof c === "number" &&
                b.$VideoPlayerHTML5Oz29 &&
                b.$VideoPlayerHTML5Oz29.setStreamType(c);
            }
          };
        c();
        this.$VideoPlayerHTML5Oz11.addSubscriptions(
      ...
      f.$VideoPlayerHTML5Oz64 = function (a) {
        var b = this,
          c = function () {
            (b.$VideoPlayerHTML5Oz31 = !!a.getCustomField(
              "hasInbandCaptionsFromUsingASRCaptions"
            )),
              b.$VideoPlayerHTML5Oz72(
                !!a.getCustomField("hasInbandCaptionsFromAccessibility") ||
                  b.$VideoPlayerHTML5Oz31
              );
          };
        c();
        this.$VideoPlayerHTML5Oz11.addSubscriptions(
      ...
      f.$VideoPlayerHTML5Oz72 = function (a) {
        if (this.$VideoPlayerHTML5Oz6 === a) return;
        this.$VideoPlayerHTML5Oz6 = a;
        this.$VideoPlayerHTML5Oz6 &&
          this.$VideoPlayerHTML5Oz4 != null &&
          this.$VideoPlayerHTML5Oz4.updatePlayerRunTimeConfig({
            videoStreamDataHandler: this.$VideoPlayerHTML5Oz68(),
          });
      ...
      f.$VideoPlayerHTML5Oz63 = function (a) {
        ...
        this.$VideoPlayerHTML5Oz3.getNumber(
          ...
          this.$VideoPlayerHTML5Oz11.addSubscriptions(
            a.addListener("streamInterruptAt", function (a) {
              (b.$VideoPlayerHTML5Oz24 = a),
                b.$VideoPlayerHTML5Oz22 &&
                  (b.emit("bufferingEnd"),
                  b.$VideoPlayerHTML5Oz9 &&
                    (b.$VideoPlayerHTML5Oz9.log(),
                    (b.$VideoPlayerHTML5Oz9 = null))),
                b.$VideoPlayerHTML5Oz73();
            }),
            a.addListener("streamResumedAt", function (a) {
              (b.$VideoPlayerHTML5Oz25 = a),
                b.$VideoPlayerHTML5Oz23 && b.$VideoPlayerHTML5Oz74();
            })
          );
      };
      f.$VideoPlayerHTML5Oz73 = function () {
        this.emit("streamInterrupted"),
          (this.$VideoPlayerHTML5Oz22 = !1),
          (this.$VideoPlayerHTML5Oz23 = !0),
          this.$VideoPlayerHTML5Oz8 &&
            (this.$VideoPlayerHTML5Oz10 =
              this.$VideoPlayerHTML5Oz8.getOperationLogger(
                "stream_interrupted"
              ));
      };
      f.$VideoPlayerHTML5Oz74 = function () {
        this.emit("streamResumed"),
          this.$VideoPlayerHTML5Oz10 &&
            (this.$VideoPlayerHTML5Oz10.log(),
            (this.$VideoPlayerHTML5Oz10 = null)),
          (this.$VideoPlayerHTML5Oz23 = !1);
      };
      f.play = function () {
        this.$VideoPlayerHTML5Oz21 && this.$VideoPlayerHTML5Oz21.playStarted();
      ...
      f.reload = function () {
        if (
          this.$VideoPlayerHTML5Oz3.getBool("enable_abortload_and_reload", !1)
        ) {
          this.$VideoPlayerHTML5Oz50();
          this.setup();
      ...
      f.unload = function () {
        this.$VideoPlayerHTML5Oz11.release();
        this.$VideoPlayerHTML5Oz9 &&
          (this.$VideoPlayerHTML5Oz9.log(), (this.$VideoPlayerHTML5Oz9 = null));
        this.$VideoPlayerHTML5Oz10 &&
          (this.$VideoPlayerHTML5Oz10.log(),
          (this.$VideoPlayerHTML5Oz10 = null));
        this.$VideoPlayerHTML5Oz21 && this.$VideoPlayerHTML5Oz21.unload();
        var a = b("Promise").resolve();
        this.$VideoPlayerHTML5Oz3.getBool("enable_abortload_and_reload", !1) &&
          (this.$VideoPlayerHTML5Oz60(),
          this.$VideoPlayerHTML5Oz4 &&
            ((a = this.$VideoPlayerHTML5Oz4.destroy()),
            (this.$VideoPlayerHTML5Oz4 = null)));
        return a;
      };
      f.getVideoStreamInfoIDForTimePosition = function (a) {
        return !this.$VideoPlayerHTML5Oz4
          ? null
          : this.$VideoPlayerHTML5Oz4.getVideoRepresentationIDAtTime(a);
      };
      f.getAudioStreamInfoIDForTimePosition = function (a) {
        return !this.$VideoPlayerHTML5Oz4
          ? null
          : this.$VideoPlayerHTML5Oz4.getAudioRepresentationIDAtTime(a);
      };
      ...
      f.getSelectedVideoQuality = function () {
        return !this.$VideoPlayerHTML5Oz4
          ? null
          : this.$VideoPlayerHTML5Oz4.getSelectedVideoQuality();
      };
      f.unsetPreferredVideoQuality = function () {
        this.$VideoPlayerHTML5Oz4 &&
          this.$VideoPlayerHTML5Oz4.enableVideoQualityAdaptation();
      };
      f.getAvailableVideoQualities = function () {
        return d("VideoPlayerQualitiesArray").ensureVideoPlayerQualitiesArray(
          this.$VideoPlayerHTML5Oz4
            ? this.$VideoPlayerHTML5Oz4.getVideoQualities()
            : []
        );
      };
      ...
      f.isDrm = function () {
        ...
        a == null &&
          this.$VideoPlayerHTML5Oz2 &&
          (a = this.$VideoPlayerHTML5Oz2.indexOf("<ContentProtection") >= 0);
        return a;
      };
      ...
      f.getDebug = function () {
        return {
          ...
          AbrManager: this.$VideoPlayerHTML5Oz4
            ? this.$VideoPlayerHTML5Oz4.getDebug().VideoAbrManager
            : null,
      ...
      f.setEnableLiveheadCatchup = function (a) {
        this.$VideoPlayerHTML5Oz4 &&
          this.$VideoPlayerHTML5Oz4.setEnableLiveheadCatchup(a);
      };
          ...
          if (a.length) {
            ...
            a = Math.max(
              a[a.length - 1].endTime -
                this.$VideoPlayerHTML5Oz3.getNumber(
                  "live_rewind_seek_to_live_delta",
                  8
                ),
              b
            );
            return new (c("TimeRanges"))([{ startTime: b, endTime: a }]);
          }
        }
      };
      ...
      f.switchReplicaSet = function (a) {
        var b = new (c("URI"))(this.$VideoPlayerHTML5Oz13);
        b.addQueryData("replica", a);
        this.$VideoPlayerHTML5Oz13 = b.toString();
      };
