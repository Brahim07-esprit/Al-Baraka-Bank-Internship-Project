  ...
  function (a, b, c, d, e, f, g, h) {
    ...
    function l(a, b, e, f, g) {
      ...
      switch (n) {
        ...
        case "theater":
          !c("Env").isCQuick
            ? d("PhotoSnowliftLoader").load(m, b, f)
    ...
    c("Event").listen(
      ...
      function (a) {
        ...
        b instanceof HTMLAnchorElement
          ? (b = l(a, b, j))
          : (b = d("PrimerInlineHandlers").run(j, a, "data-onclick"));
        b == null &&
          (b = d("ReactServerPrimer").handleEvent("data-sr-onclick", a, j));
        return b;
      },
