  ...
  function (a, b, c, d, e, f, g) {
    ...
    function a(a, b) {
      ...
      var e = [],
        f = 0,
        g = [],
        h = a.getCurrentContent();
      h.getBlockMap().forEach(function (a) {
        var i = "",
          j = 0;
        a.findEntityRanges(c("emptyFunction").thatReturnsTrue, function (c, g) {
          var k = b.some(function (b) {
            var k = a.getText().slice(0, c);
            k = Math.max(0, k.length - d("UnicodeUtils").strlen(k));
            b = b(a, h, c, g);
            if (b != null) {
              var l = f - k + j;
              k = b.message;
          ...
          k || (i += a.getText().slice(c, g).replace(/@\[/g, "@ ["));
        });
        f += d("UnicodeUtils").strlen(i) + 1;
        g.push(i);
      });
      a = g.join("\n");
...
__d(
  ...
  function (a, b, c, d, e, f, g) {
    ...
    function a(a, b, c, e) {
      ...
      b = b.getEntity(f);
      if (b.getType() !== "MENTION") return null;
...
__d(
  ...
  function (a, b, c, d, e, f, g, h) {
    ...
    function e() {
      return c("gkx")("1260876");
    }
    function f() {
      var a;
      return (a = c("gkx")("1799017")) != null ? a : !0;
    }
    function i() {
      if (j()) return h._("Partagez une photo, une vid\u00e9o ou un message");
      else return h._("Partagez une photo ou un message.");
    }
    function j() {
      var a;
      return (a = c("qex")._("1573")) != null ? a : !1;
    }
    function k() {
      return !1;
    }
    ...
    function m() {
      var a;
      return (a = c("qex")._("1582")) != null ? a : 2;
    }
    function n() {
      if (o()) return !0;
      else return !1;
    ...
    function p() {
      var a;
      return (a = c("qex")._("1585")) != null ? a : 4;
    }
    function q() {
      var a;
      return (a = c("qex")._("173")) != null ? a : !1;
    }
    function r() {
      return !1;
    }
    ...
    function u() {
      return h._(
        "Apr\u00e8s 14 jours, vous ne verrez pas si une personne a vu une story, sauf en cas d\u2019interaction avec cette story."
      );
    }
    function v() {
      var a;
      return (a = c("qex")._("1598")) != null ? a : !1;
    }
    function w() {
      var a;
      return (a = c("qex")._("68")) != null ? a : !1;
    }
    function x() {
      var a;
      return (a = c("qex")._("896") && c("qex")._("915")) != null ? a : !1;
    }
    function y() {
      var a;
      return (a = c("qex")._("894")) != null ? a : 4;
    }
    function z() {
      var a;
      return (a = c("qex")._("297")) != null ? a : !1;
    }
    function A() {
      var a;
      return (a = c("qex")._("146")) != null ? a : !1;
    }
    function B() {
      return c("gkx")("6746");
    }
    function C() {
      var a;
      return (a = c("gkx")("3899")) != null ? a : !1;
    }
    function D() {
      var a;
      return (a = c("qex")._("1111")) != null ? a : !1;
    }
    function E() {
      var a;
      return (a = c("qex")._("457")) != null ? a : !1;
    }
    function F() {
      return c("gkx")("1112");
    }
    function G() {
      var a;
      return (a = c("qex")._("477")) != null ? a : !1;
    }
    function H() {
      var a;
      return (a = c("gkx")("3309")) != null ? a : !1;
    }
    function I() {
      return c("gkx")("1220640") && !c("gkx")("6277");
    }
    function J() {
      return c("gkx")("1261311");
    }
    function K() {
      return 5;
    }
    ...
    g.isEmployee = b;
    g.isTest = d;
    g.shouldMockLogging = e;
    g.allowedByEPDClientFeatureBlock = f;
    g.getCreationDescription = i;
    g.isCometStoriesVideoProductionEnabled = j;
    g.shouldEnableOptimisticImprovements = k;
    g.shouldEnableStickerProduction = l;
    g.getMinBufferedBucketsCount = m;
    g.shouldShowViewerV3 = n;
    g.shouldSeparateQueryViewerV3 = o;
    g.getViewerV3BackgroundBucketsCount = p;
    g.shouldUseTrayOrder = q;
    g.shouldUsePreviewFilter = r;
    g.shouldEnableStickerReplyFlyoutNullstate = s;
    g.shouldDisplayViewsDeprecatingMessage = t;
    g.getViewerNotAvailableFooterText = u;
    g.shouldEnableLiveInStories = v;
    g.shouldEnableArmadilloStoryReply = w;
    g.shouldShowSuggestedStories = x;
    g.getTileGridRowLength = y;
    g.shouldShowCreateButton = z;
    g.isCommentPreviewsEnabled = A;
    g.shouldShowAudienceIcon = B;
    g.shouldFixHostedForNotification = C;
    g.shouldShowStoriesRing = D;
    g.getShouldDisableCR = E;
    g.shouldEnableExtendedViewerAutoDismiss = F;
    g.isInterATS = G;
    g.shouldDisableBottomOverlay = H;
    g.isStoriesArchiveEnabled = I;
    g.shouldLogStoryMediaView = J;
    g.getHScrollRefetchCount = K;
    g.getTrayBucketCount = L;
    g.shouldDeferLoad = M;
    g.shouldDisableBucketTransitionAnimation = N;
    g.isCommentEnabled = O;
    g.shouldUseCommentsSheet = P;
    g.isTabbedTrayDisabled = Q;
  },
  98
);
__d(
  ...
  function (a, b, c, d, e, f) {
    d = "!\"#%&'()*,-./:;<>?@[\\]^_`{|}";
    f = "\u2000-\u206f\xab\xbb\uff08\uff09";
    var g = "(?:25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9]?[0-9])",
      h = "(?:(?:ht|f|sf)tps?)://";
    g = "(?:(?:" + g + "[.]){3}" + g + ")";
    var i = "\\[(?:(?:[A-Fa-f0-9]{1,4}::?){1,7}[A-Fa-f0-9]{1,4})\\]",
      j = "(?:\\b)www\\d{0,3}[.]";
    d = "[^\\s" + d + f + "]";
    f = "(?:(?:(?:[.:\\-_%@]|" + d + ")*" + d + ")|" + i + ")";
    d = "(?::\\d+){0,1}";
    ...
    var m = "[^\\s()<>?#]+",
      n = new RegExp(l, "im"),
      o = "^\\[[0-9]{1,4}:[0-9]{1,4}:[A-Fa-f0-9]{1,4}\\]",
      p = new RegExp(o, "im"),
      q = "(?:(?:" + g + ")(?:(?:" + i + "|" + m + ")*)*)*",
      r = new RegExp("((?:" + k + ")(?:" + q + "))", "im");
    function a() {
    ...
    var s = new RegExp("((?:" + h + f + d + ")|(?:" + j + f + b + d + "))"),
      t = /[\s\'\";]/,
      u = new RegExp(g, "im"),
      v = new RegExp(
        "[\\s!\"#%&'()*,./:;<>?@[\\]^`{|}\xab\xbb\u2000-\u206f\uff08\uff09]",
      ...
      x = new RegExp("\\s()<>"),
      y = function (a) {
        if (a != null && a.indexOf("@") != -1) return s.exec(a) ? a : null;
        else return a;
      },
      z = function (a) {
        return new RegExp("((?:" + l + ")(?:" + q + "))", a);
      };
    function c() {
      return r.source;
    }
    ...
    var A = function (a, b) {
        b = b.exec(a);
        return b == null || b.length === 0 ? null : y(b[1] || null);
      },
      B = function (a, b) {
        a = a.match(b);
    ...
    h = function (a) {
      return !t.test(a.charAt(a.length - 1));
    };
    j = function (a) {
      a = a;
      var b = !1;
      ...
      if (d.length === 0 || !u.test(d[0])) return y(c[0]);
      b = 0;
      a = 0;
      var e = 1,
        f = 0,
      ...
      for (var h = 1; h < d.length; h++) {
        ...
        if (g === a) {
          if (i === "(") (f += 1), (g = e);
          else if (u.test(i) || !v.test(i)) b = h;
          else if (w.test(i)) break;
        } else if (i === "(") f += 1;
        else if (i === ")") (f -= 1), f === 0 && ((g = a), (b = h));
        else if (x.test(i)) break;
      }
      return y(c[0] + d.substring(0, b + 1));
    };
    f = {
      compilePermissiveHostPathMatcher: a,
      permissiveHostPathMatch: m,
      permissiveMatch: o,
      permissiveMultiMatch: i,
      matchToPattern: A,
      multiMatchToPattern: B,
      matchHost: k,
      trigger: h,
      match: j,
      getPermissiveHostPathMatcherSource: c,
    };
    e.exports = f;
  },
  null
...
__d(
  "URLScraper",
  ["ArbiterMixin", "DataStore", "Event", "URLMatcher", "mixin"],
  function (a, b, c, d, e, f, g) {
    ...
    a = (function (a) {
      ...
      e.check = function (a) {
        ...
        c &&
          c != d("DataStore").get(this.input, h) &&
          (d("DataStore").set(this.input, h, c),
          this.inform("match", { url: a || c, alt_url: c }));
      };
      return b;
  ...
  function (a, b, c, d, e, f, g) {
    ...
    function a(a) {
      ...
      while (!0) {
        ...
        e += f;
        i = g.length;
        b.push({ offset: e, length: g.length, entity: { url: h } });
        e += i;
      }
      return b;
    }
...
__d(
  ...
  function (a, b, c, d, e, f, g) {
    "use strict";
    a = c("getFalcoLogPolicy_DO_NOT_USE")("1743444");
    b = d("FalcoLoggerInternal").create("composer_cancel", a);
    e = b;
    g["default"] = e;
  },
  98
...
__d(
  ...
  function (a, b, c, d, e, f, g) {
    "use strict";
    a = c("getFalcoLogPolicy_DO_NOT_USE")("1743449");
    b = d("FalcoLoggerInternal").create("composer_entry", a);
    e = b;
    g["default"] = e;
  },
  98
...
__d(
  ...
  function (a, b, c, d, e, f, g) {
    "use strict";
    a = c("getFalcoLogPolicy_DO_NOT_USE")("1743455");
    b = d("FalcoLoggerInternal").create("composer_post_failure", a);
    e = b;
    g["default"] = e;
  },
  98
...
__d(
  ...
  function (a, b, c, d, e, f, g) {
    "use strict";
    a = c("getFalcoLogPolicy_DO_NOT_USE")("1743456");
    b = d("FalcoLoggerInternal").create("composer_post", a);
    e = b;
    g["default"] = e;
  },
  98
...
__d(
  ...
  function (a, b, c, d, e, f, g) {
    "use strict";
    a = c("getFalcoLogPolicy_DO_NOT_USE")("1743459");
    b = d("FalcoLoggerInternal").create("composer_post_success", a);
    e = b;
    g["default"] = e;
  },
  98
...
__d(
  ...
  function (a, b, c, d, e, f, g) {
    ...
    function a() {
      var a,
        b = c("SiteData")[c("StaticSiteData").spin_mhenv_key];
      b = babelHelpers["extends"](
        ((a = {}),
        (a[c("StaticSiteData").hs_key] = c("SiteData").haste_session),
        (a[c("StaticSiteData").spin_rev_key] =
          c("SiteData")[c("StaticSiteData").spin_rev_key]),
        (a[c("StaticSiteData").spin_branch_key] =
          c("SiteData")[c("StaticSiteData").spin_branch_key]),
        (a[c("StaticSiteData").spin_time_key] =
          c("SiteData")[c("StaticSiteData").spin_time_key]),
        a),
        Boolean(b)
          ? ((a = {}), (a[c("StaticSiteData").spin_mhenv_key] = b), a)
          : null
      );
      return new Map(c("objectEntries")(b));
    }
    g["default"] = a;
  },
  98
