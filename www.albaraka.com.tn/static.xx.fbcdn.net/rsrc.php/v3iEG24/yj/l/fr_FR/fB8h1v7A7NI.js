...
__d(
  "BUIPrivateLoggingRegionContext",
  ["react"],
  function (a, b, c, d, e, f, g) {
    "use strict";
    a = d("react");
  ...
  function (a, b, c, d, e, f, g) {
    ...
    function a(a) {
      var b = a.children,
        ...
        f = e === void 0 ? !1 : e,
        g = a.name;
      e = i(c("BUIPrivateLoggingRegionContext"));
      a = e.renderer;
      var k = e.setupElement,
        l = i(c("BUIPrivateLoggingRegionHierarchyContext"));
      e = j(
        function () {
          return l.concat(g);
        },
      ...
      m = b(d);
      return h.jsx(c("BUIPrivateLoggingRegionHierarchyContext").Provider, {
        value: e,
...
__d(
  "BUIPrivateCardLayoutContext",
  ["react"],
  function (a, b, c, d, e, f, g) {
    "use strict";
    a = d("react");
    b = a.createContext({ hasHeader: !0, hasFooter: !0 });
    c = b;
    g["default"] = c;
  },
  98
  ...
  function (a, b, c, d, e, f, g, h) {
    ...
    function a(a) {
      var b = a.children,
        ...
        g = f === void 0 ? !0 : f;
      f = a["data-testid"];
      a = j(c("BUIPrivateThemeContext.react"));
      var h = j(c("BUIPrivateCardSectionContext")),
        k = d("BUIPrivateThemeUtils").isGeo(a) && g;
      return i.jsx(c("BUIPrivateCardLayoutContext").Consumer, {
        children: function (a) {
          var d = a.hasHeader,
            f = a.hasFooter;
          return i.jsx(c("BUIPrivateLoggingRegion.react"), {
            inputRef: e,
            isDependentRegion: h,
            name: "BUISection",
            children: function (a) {
              return i.jsx("div", {
                ...
                "data-testid": void 0,
                ref: a,
                children: i.jsx(c("SUIErrorBoundary.react"), { children: b }),
              });
            },
          });
        },
    ...
    a.displayName = a.name + " [from " + f.id + "]";
    b = c("makeBUIStandardComponent")("BUISection", a);
    g["default"] = b;
  },
  98
);
